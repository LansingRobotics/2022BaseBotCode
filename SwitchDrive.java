...
public class SwitchDrive extends CommandBase {
  ...
  private static void singleTankDriveExecute() {
    ...
    Robot.driveTrain.squeezeTheClaw(Robot.controller1.getDifferenceInBumpers());
  ...
  private static void doubleTankDriveExecute() {
    ...
    Robot.driveTrain.squeezeTheClaw(Robot.controller2.getDriverRawAxis(RobotMap.LEFT_STICK_Y));
