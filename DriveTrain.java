...
public class DriveTrain extends SubsystemBase {
  ...
  private static final WPI_VictorSPX rightRearDrive = new WPI_VictorSPX(RobotMap.LEFT_REAR_DRIVE);
  private static final WPI_VictorSPX leftFrontDrive = new WPI_VictorSPX(RobotMap.RIGHT_FRONT_DRIVE);
  private static final WPI_VictorSPX rightFrontDrive = new WPI_VictorSPX(RobotMap.LEFT_FRONT_DRIVE);
  private static final WPI_VictorSPX leftRearDrive = new WPI_VictorSPX(RobotMap.RIGHT_REAR_DRIVE);
  private static final WPI_VictorSPX armLifter = new WPI_VictorSPX(RobotMap.ARM_LIFTER);
  private static final WPI_VictorSPX claw = new WPI_VictorSPX(RobotMap.CLAW);
  ...
  // Controlls the opening and closing of the claw
  public void squeezeTheClaw(double power) {
    claw.set(ControlMode.PercentOutput, power * Robot.gui.getClawPower(), DemandType.ArbitraryFeedForward,
        RobotMap.NOTHING);
  }

  // controller for the arm lifting motor
  public void liftTheArm(double power) {
    armLifter.set(ControlMode.PercentOutput, power * Robot.gui.getArmLifterPower(), DemandType.ArbitraryFeedForward,
        RobotMap.NOTHING);
  }
